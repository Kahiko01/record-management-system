...
class RegistryInventory(Base):
    ...
    # Used string format for foreign_keys to avoid NameError since StorageLocationHistory is defined below
    location_history = relationship("StorageLocationHistory", foreign_keys="StorageLocationHistory.certificate_id")
...
class StorageLocationHistory(Base):
    ...
    action = Column(String, nullable=False)  # assigned, moved, removed
