        ...
        <main className="flex-1 ml-64 p-6 lg:p-8 min-h-screen">
          <div className="mx-auto max-w-7xl space-y-6">
            ...
            <header className="bg-white dark:bg-slate-900 rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200/80 dark:border-slate-800 relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-purple-500 to-blue-700" />
              ...
              <p className="mt-2 max-w-3xl text-sm text-slate-500 dark:text-slate-400">
                Collection metrics, graduation cohort tracking, and exception reporting for operational oversight.
              </p>
            </header>
